...
public class CutView extends View {
	...
	/** 裁剪框长宽比，默认4：3 */
	private double cutRatio = 1; //0.75
	/** 裁剪框宽度 */
	...
	protected void onDraw(Canvas canvas) {
		...
		// left
		canvas.drawRect(0, cutTopMargin, cutLeftMargin, cutTopMargin
				+ cutHeight, paint);
		// right
		canvas.drawRect(cutLeftMargin + cutWidth, cutTopMargin, width,
				cutTopMargin + cutHeight, paint);
		// bottom
		...
		canvas.drawRect(cutLeftMargin, cutTopMargin, cutLeftMargin
				+ cutWidth, cutTopMargin + cutHeight, borderPaint);
